...
/*
   ...
   BEST-HNCACO 1H-15N-13CACO experiment   

   Correlates CO(i) with N(i), NH(i), N(i+1), NH(i+1).	
...
/*   INITIALIZE VARIABLES   */
   ...
   pwS8 = c_simshapedpw("reburp",60.0 ,-135.0,0.0,pwN*2.0,zero,zero,zero, 0.0, 0.0);
...
/**************************************************************************/
       ...
       set_c13offset("co");
        ...
        delay(tau1*0.5);
        sim3_c13pulse("", "ca", "co", "square", "", 0.0, 180.0, 2.0*pwN,
                                                  zero, zero, zero, 2.0e-6, 0.0);        delay(tau1*0.5);
