...
/*  hbcbcgcdhdA.c - auto-calibrated version of the original sequence
    ...
    2D correlation of cb and hd of aromatic residues.
                       F1        CB
                       F2(acq)   HD of aromatic
    ...
    Added 2us delays between power and pulse statements-to be
    compatible with UnityInova - RM Mar.06/97

    Added Automatic Pbox, E.Kupce, Jan 03, Converted *DEV* to new style, GG, mar 03
       ...
       the original code).
    converted rgradient statements to zgradpulse statements. Added gstab.
    changed pwc->pwC, dhpwr->pwClvl for consistency with BioPack
