...
/*  hcch_tocsy.c               
   ...
   Use ncyc = 2 for spinlocks 7-9kHz.  This corresponds to a total mixing time of
   (2)*7.8*600/sfrq msec. For spinlock of 5000Hz, use ncyc=1. The DIPSI rf field should be
