 ...
 */
/* ghncn.c  3D gradient sensitivity-enhanced  HN(C)N
    ...
    Sequence contributed by S.C.Panchal, N.S.Bhavesh and R.V.Hosur, Tata Institute,
      Mumbai, India (March 2002). See J.Biomol.NMR, 20, 135-147(2001) and BBRC, 311,
      678-684(2003).
...
double      tau1,         				         /*  t1 delay */
            tau2,        				         /*  t2 delay */
            timeCN = getval("timeCN"),/* time for CN transfer (typ. 10-15msec)*/  
