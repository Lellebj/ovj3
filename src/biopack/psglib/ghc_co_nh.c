...
/*  ghc_co_nh.c               
    ...
    ignored if ni=0, and f2180='y' is ignored if ni2=0.
          	  ...
          	  DETAILED INSTRUCTIONS FOR USE OF ghc_co_nh

    1. Obtain a printout of the Philosopy behind the BioPack development,
       and General Instructions using the macro: 
                                      "printon man('BioPack') printoff".
       These Detailed Instructions for ghc_co_nh may be printed using:
                                      "printon man('ghc_co_nh') printoff".
             
    2. Apply the setup macro "ghc_co_nh".  This loads the relevant parameter set
   ...
   10. TROSY:
       ...
       ghc_co_nh so the N15 magnetization has not evolved with respect to the 
...
/* directly from your shapelib.                    			      */
   ...
   phi7cal = getval("phi7cal"),  /* phase in degrees of the last C13 90 pulse */
   	...
   	tpwr1,	  	                 /* DIPSI-2 fine power level          */
...
/*   INITIALIZE VARIABLES   */
	...
	ncyc_dec = (DIPSI2time*90.0)/(pwH*2590.0*4.0);
        pwH   = (DIPSI2time*90.0)/(ncyc_dec*2590*4.0);   /* fine correction of pwH */

	tpwr1 = 4095.0*(compH*pw/pwH);
	tpwr1 = (int) (2.0*tpwr1 + 0.5); /* x2 because obs atten will be reduced 6dB */
