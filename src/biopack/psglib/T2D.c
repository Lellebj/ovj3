...
/*  T2D.c 
    ...
    Modified by L. E. Kay, Aug 31, 1995 from CH2D_T1_D_v6.c
    Added deuterium flipback pulses, RM Oct 11, 1995.

    Records carbon chemical shift during the second CT period

    Modified by L.E.Kay, Jan 19,96 to ensure 4us between power
     change and pulses.

    Modified by L.E.Kay, Jan 31,96 to compensate for phase change of
     the reburp pulses.
