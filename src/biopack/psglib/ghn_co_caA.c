...
static shape   H2Osinc, wz16, offC1, offC2, offC3, offC6, offC8, offC9, g180;
...
/* directly from your shapelib.                    			      */
   ...
   compC = getval("compC"),       /* adjustment for C13 amplifier compression */
   	...
   	tpwrsf,                       /* fine power adjustment for flipback   */
   	pwr_dly,
...
/*   xxxxxxxxxxxxxxxxxxxxxx       13Ca EVOLUTION       xxxxxxxxxxxxxxxxxx    */
   ...
   else if(CT_c[A] == 'y')           /* xxxxxxx 13Ca Constant Time EVOLUTION xxxxxxxx */
   {
     ...
     decrgpulse(pwC1, t3, 2.0e-6, 0.0);
     decphase(zero);
     decpwrf(rf9);
     if(tau1 - 2.0*pwC1/PI - WFG_START_DELAY -POWER_DELAY > 0.0) {
       delay(tau1 -2.0*pwC1/PI -POWER_DELAY -WFG3_START_DELAY);
     ...
     delay(timeTC- 2.0e-6 -WFG3_STOP_DELAY-POWER_DELAY); 
