 ...
 */
/*   BEST-HNCA 1H-15N-13CA experiment  

    Correlates Ca(i) with N(i), NH(i), and N(i+1), NH(i+1).

 href_flg:y (HN refocus during NCO transfer)
...
/**************************************************************************/
   ...
   obspower(tpwr);
      ...
      if (SE_flg[0] == 'y')
      {
        ...
        {
           delay(tau2*0.5);
        sim_c13pulse(shname1,"co", "ca", "sinc",shpw1, 180.0, two,zero, 0.0, 0.0);
