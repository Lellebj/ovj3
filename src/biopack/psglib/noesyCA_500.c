 ...
 */
/*  noesyCA.c   auto-calibrated version of noesy_C_chirp_purge_lek_v3a.c (D2O,500MHz) 
...
#include "Pbox_bio.h"
/* first two lines after this section are field-dependent. Substitute proper lines
   for your magnetic field 

500MHz:
#define CHIRP1   "wurst180-20 -54k/1.793m -67p"            
#define CHIRP2   "wurst180-20 -54k/2.750m -67p"             

600MHz:
#define CHIRP1   "wurst180-20 -54k/1.536m -67p"            
#define CHIRP2   "wurst180-20 -54k/2.359m -67p"             

750MHz
#define CHIRP1   "wurst180-20 -54k/1.631m -67p"            
#define CHIRP2   "wurst180-20 -54k/2.491m -67p"             

800MHz
#define CHIRP1   "wurst180-20 -54k/1.527m -67p"            
#define CHIRP2   "wurst180-20 -54k/2.538m -67p"             

the CHIRPi and CODEC shapes are the same for all fields 
*/

/* define strings to be used in the Pbox statements below */
#define CHIRP1   "wurst180-20 -54k/1.793m -67p"                    /* WURST 180 on resonance  */
#define CHIRP2   "wurst180-20 -54k/2.750m -67p"                     /* WURST 180 on resonance  */

#define CHIRPi   "cawurst-8 -54k/0.5m"                           /* WURST 180 on resonance  */
