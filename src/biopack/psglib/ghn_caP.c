...
/*  ghn_caP.c
    ...
    ignored if ni=0, and f2180='y' is ignored if ni2=0.
           	  ...
           	  DETAILED INSTRUCTIONS FOR USE OF ghn_caP

    1. Obtain a printout of the Philosopy behind the BioPack development,
       and General Instructions using the macro: 
                                      "printon man('BioPack') printoff".
       These Detailed Instructions for ghn_caP may be printed using:
                                      "printon man('ghn_caP') printoff".
             
    2. Apply the setup macro "ghn_caP".  This loads the relevant parameter set
    ...
    3. Center H1 frequency on H2O (4.7ppm), C13 on 174ppm, and N15 frequency
       ...
       sequence to be at 56ppm, ie at Ca throughout the sequence.
    ...
    5. H2O preservation is achieved according to Kay et al, except that a sinc
       ...
       chosen by changing the strength parameter, waltzB1. The new value is in the
    ...
    9. TROSY:
       ...
       ghn_caP so the N15 magnetization has not evolved with respect to the 
