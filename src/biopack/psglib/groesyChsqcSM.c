 ...
 */
/*  groesyChsqcSM.c - BioPack pulse sequence adapted for Small Molecules 
                      Eriks Kupce, Oxford, 2005 

    3D C13-H1 ROESY-HSQC with sensitivity-enhancement in 13C dimension. 

    Uses three channels:
         1)  1H             - carrier @ water  
         2) 13C             - carrier @ 43 ppm  (for aliphatic C-s)
                            - carrier @ 125 ppm (for aromatic C-s)
         3) 15N (optional)  - carrier @ 120 ppm
