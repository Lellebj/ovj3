 ...
 */
/*
 * Copyright (c) 2007 Varian, Inc. All Rights Reserved.
 */
...
public interface AptDefs {
    ...
    /** The port used to connect to an Optima motor module. */
    public final static int OPTIMA_MOTOR_PORT = TELNET_PORT;
    ...
    static public final int STATUS_CALIBRATING = 7;
    static public final Color STATUS_CALIBRATING_COLOR = Color.orange;
    static public final String STATUS_CALIBRATING_MSG = "Motor Cal...";

    static public final int STATUS_FIRMWARE = 8;
    static public final Color STATUS_FIRMWARE_COLOR = Color.lightGray;
    static public final String STATUS_FIRMWARE_MSG = "Updating Firmware...";

    // NB: These STATUS_INDEXING_X values must be kept consecutive!
    static public final int STATUS_INDEXING0 = 10;
    static public final String STATUS_INDEXING0_MSG = "Indexing Motor 0...";

    static public final int STATUS_INDEXING1 = 11;
    static public final String STATUS_INDEXING1_MSG = "Indexing Motor 1...";

    static public final int STATUS_INDEXING2 = 12;
    static public final String STATUS_INDEXING2_MSG = "Indexing Motor 2...";

    static public final int STATUS_INDEXING3 = 13;
    static public final String STATUS_INDEXING3_MSG = "Indexing Motor 3...";

    static public final int STATUS_INDEXING4 = 14;
    static public final String STATUS_INDEXING4_MSG = "Indexing Motor 4...";

    static public final int STATUS_INDEXING5 = 15;
    static public final String STATUS_INDEXING5_MSG = "Indexing Motor 5...";

    static public final int STATUS_INDEXING6 = 16;
    static public final String STATUS_INDEXING6_MSG = "Indexing Motor 6...";

    static public final int MAX_DEGREES_PER_STEP = 900;
    static public final int MAX_STEP_SIZE = 500; // For legacy ProTune
