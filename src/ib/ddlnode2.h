...
class DDLNode : public DDLNodeList {
 ...
 public:
  ...
  virtual DDLNode* Clone(int dataflag=TRUE) {return new DDLNode(this); };

  DDLNode* Index(int i);

  DDLNode* CloneList(int dataflag=TRUE);
  void Delete();
...
class RealData : public DDLNode {
 ...
 public:
  ...
  virtual DDLNode* Clone(int dataflag=TRUE) { return new RealData(this); };
  operator double();
...
class StringData : public DDLNode {
 ...
 public:
  ...
  virtual DDLNode* Clone(int dataflag=TRUE) { return new StringData(this); };
  ~StringData();
  operator char*();
  ostream& operator >>(ostream& os);
...
class ArrayData : public DDLNode {
 ...
 public:
  ...
  int GetValue(int& value, int index);
  int GetValue(double& value, int index);
  int GetValue(char*& value, int index);
  ArrayData *GetArray(int index);
  ArrayData();
  ArrayData(ArrayData* old);
  virtual DDLNode* Clone(int dataflag=TRUE) { return new ArrayData(); };
  ~ArrayData();
};
...
class CodeData : public DDLNode {
 public:
  ...
  virtual DDLNode* Clone(int dataflag=TRUE) { return new CodeData(); };
  ~CodeData() {};
};
