...
ParmList
allocParm(const char *name, int type, int nelems)
{
    ParmList rtn;
    char *pname;
...
ParmList
appendStrParm(ParmList p, const char *value)
{
    ParmList rtn = NULL;
    int n;
...
ParmList
findParm(ParmList p, const char *name)
{
    int i;
    int n;
    ParmList q;
 ...
 */
int
setStrParm(ParmList p, const char *value, int elem)
{
    char *s;
    int rtn = 0;
    if (p
...
int
setStrParms(ParmList p, const char **array, int n)
{
    int rtn = 0;
    int ok = 1;
    int i;
