...
extern "C" {
    ...
    extern void write_ddl_data(DDLSymbolTable *st, const char *fname);
    extern int get_header_int(DDLSymbolTable *st, const char *name, int *pval);
    extern int get_header_double(DDLSymbolTable *st, const char *name,
                                 double *pval);
    extern int get_header_string(DDLSymbolTable *st, const char *name,
                                 char **pval);
    extern int get_header_array_int(DDLSymbolTable *st, const char *name, int n,
				    int *pval);
    extern int get_header_array_double(DDLSymbolTable *st, const char *name,
                                       int n, double *pval);
    extern int get_header_array_string(DDLSymbolTable *st, const char *name,
                                       int n, char **pval);
