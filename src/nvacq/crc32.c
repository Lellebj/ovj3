...
/*       Varian,Inc.
    ...
    e.g.
     if (1st time -  give 3rd arg as null )
       ...
       crcChksum = addbfcrcinc(bufAddr,incrsize,(tcrc*) 0);

     else (2nd,3rd,4th, etc... -  3rd argument previous crc value )

       crcChksum = addbfcrcinc(bufAddr,incrsize, &crcChksum);

          Greg Brissey    4/16/2004
*/
...
tcrc crctab[] = { /* CRC polynomial 0xedb88320 */
