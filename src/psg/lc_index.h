...
/*  Indicies for real-time variables on the new digital console  */
...
#define V15INDEX (V13INDEX + 1)
#define RTTABINDEX (V15INDEX + 1)
...
#define ACTIVERCVRINDEX (DTMCTRLINDEX + MAX_STM_OBJECTS)
#define GTBLINDEX (ACTIVERCVRINDEX + 1)
#define ADCCTRLINDEX (GTBLINDEX + 1)
#define SCANFLAGINDEX (ADCCTRLINDEX + MAX_ADC_OBJECTS)
...
#define V16INDEX (INITFLAGINDEX + 1)
...
#define V14INDEX (V24INDEX + 1)
#define INCDELAYINDEX (V14INDEX + 1)
