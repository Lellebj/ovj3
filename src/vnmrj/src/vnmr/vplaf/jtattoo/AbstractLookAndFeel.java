...
abstract public class AbstractLookAndFeel extends MetalLookAndFeel {
    ...
    protected void initComponentDefaults(UIDefaults table) {
        ...
        Object[] defaults = {
            ...
            "ComboBox.background", getComboBoxBackgroundColor(),
            ...
            "List.background", getListBackgroundColor(),
            "List.selectionForeground", getSelectionForegroundColor(),
            "List.selectionBackground", getListSelectionBackgroundColor(),
            ...
            "Table.background", getTableBackgroundColor(),
            ...
            "Tree.background", getTreeBackgroundColor(),
            ...
            "Tree.textBackground", getTreeBackgroundColor(),
    ...
    public static ColorUIResource getListBackgroundColor() {
        return getTheme().getListBackgroundColor();
    }

    public static ColorUIResource getTableBackgroundColor() {
        return getTheme().getTableBackgroundColor();
    }

    public static ColorUIResource getTreeBackgroundColor() {
        return getTheme().getTreeBackgroundColor();
    }

    public static ColorUIResource getSeparatorBackgroundColor() {
        return getTheme().getSeparatorBackgroundColor();
    }

    public static ColorUIResource getComboBoxBackgroundColor() {
        return getTheme().getComboBoxBackgroundColor();
    }
    ...
    public static ColorUIResource getListSelectionBackgroundColor() {
        return getTheme().getListSelectionBackgroundColor();
    }
    ...
    public static Color getMenuForegroundColor(Color c) {
        return getTheme().getMenuForegroundColor(c);
    }
