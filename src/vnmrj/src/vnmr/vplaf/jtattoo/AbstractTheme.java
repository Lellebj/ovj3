...
public abstract class AbstractTheme extends MetalTheme {
    ...
    protected static boolean bCustomUiColor = false;
    ...
    protected static ColorUIResource comboxBackkgroundColor = null;
    ...
    protected static ColorUIResource separatorBackgroundColor = null;
    protected static ColorUIResource treeBackgroundColor = null;
    ...
    protected static ColorUIResource disableColorDark = null;
    protected static ColorUIResource inactiveColorDark = null;
    protected static ColorUIResource inactiveColorLight = null;
    ...
    protected static ColorUIResource tableBackgroundColor = null;
    ...
    protected static Color TAB_INACTIVE_COLORS[] = null;
    ...
    public void setUpColor() {
        ...
        disableColorDark = lightGray;
        inactiveColorDark = lightGray;
        inactiveColorLight = white;
    ...
    public void setUpColorArrs() {
        ...
        TAB_INACTIVE_COLORS = INACTIVE_COLORS;
    }
    ...
    public void setProperties(Properties props) {
        if (props != null) {
            ...
            if (props.getProperty("disableColorDark") != null) {
                disableColorDark = createColor(props.getProperty("disableColorDark"), disableColorDark);
            }
            if (props.getProperty("inactiveColorDark") != null) {
                inactiveColorDark = createColor(props.getProperty("inactiveColorDark"), inactiveColorDark);
            }
    ...
    public static ColorUIResource getTreeBackgroundColor() {
        return treeBackgroundColor;
    }

    public static ColorUIResource getSeparatorBackgroundColor() {
        return separatorBackgroundColor;
    }

    public ColorUIResource getComboBoxBackgroundColor() {
        return comboxBackkgroundColor;
    }
    ...
    public Color getMenuForegroundColor(Color c) {
        if (bCustomUiColor && c != null)
            return c;
    ...
    public static ColorUIResource getTableBackgroundColor() {
    ...
    public Color[] getTabRolloverColors() {
        return TAB_ROLLOVER_COLORS;
    }
    ...
    public Color[] getTabSelectedColors() {
        return SELECTED_COLORS;
    }
    ...
    public Color[] getTabInactiveColors() {
        return TAB_INACTIVE_COLORS;
    }
    ...
    public static void enableCustomUIColor(boolean b) {
        bCustomUiColor = b;
    }
}
