...
/**
 * Title: WGridLayout
 * Description:  Extends GridLayout, and sets the size of each column independently,
 *               and does not size each column the same. This code was taken from
 *               JavaWorld website from the techtip 121.
 * Copyright:    Copyright (c) 2002
 */

public class WGridLayout extends GridLayout
{
    ...
    public WGridLayout(int rows, int cols)
    {
        this(rows, cols, 0, 0);
    }
