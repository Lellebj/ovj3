...
public class VFileTable extends JScrollPane
    ...
    PropertyChangeListener
{
    ...
    public VFileTable(SessionShare ss, ButtonIF vif, String typ) {
        this.sshare = ss;
        this.type = typ;
        this.vnmrIf = vif;
    orgBg = getBackground();
    ...
    m_table.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
        ...
        if(debug)
                System.out.println("VFileTable.mouseClicked "+vnmrCmd);
    ...
    private boolean getTable(String file) {
...
// otherwise append file to USER/PERSISTENCE/
    ...
    m_tableModel = m_table.getFileTableModel();
    ...
    if(debug)
        System.out.println("VFileTable.sendContentQuery "+fileName);
    if (fileName != null)
    ...
    if(debug)
        System.out.println("VFileTable.sendValueQuery");
    if (setVal != null)
    ...
    if(debug)
        System.out.println("VFileTable.sendShowQuery");
    if (showVal != null)
    ...
    if(debug)
        System.out.println("VFileTable.sendValueCmd "+vnmrCmd);
    if (vnmrCmd != null)
    ...
    if (vnmrIf == null)
        return;
    if(debug)
        System.out.println("VFileTable.updateValue "+params);
    if(tableUpdate)
    ...
    StringTokenizer tok=new StringTokenizer(vars, " ,\n");
        while (tok.hasMoreTokens()) {
            ...
            if(debug)
            System.out.println("VFileTable.updateValue "+var);
                    if (showVal != null)
                        sendShowQuery();
                    else if (setVal != null)
                        sendValueQuery();
    ...
    if (vars == null) return;
        ...
        while (tok.hasMoreTokens()) {
            ...
            for (int k = 0; k < params.size(); k++) {
                if (var.equals(params.elementAt(k))) {
            if(debug)
            System.out.println("VFileTable.updateContent "+var);
                    tableValid=false;
            if(fileExpr)
            sendContentQuery();
            else {
    ...
    public void updateValue() {
        if (vnmrIf == null || inAddMode || inEditMode)
            return;
    if(debug)
        System.out.println("VFileTable.updateValue");
    ...
    public void setValue(ParamIF pf) {
        ...
        if(pf == null || pf.value == null)
            return;
    if(debug)
        System.out.println("VFileTable.setValue "+pf.value+" "+pf.name);
    ...
    public void setShowValue(ParamIF pf) {
        ...
        if(debug)
        System.out.println("VFileTable.setShowValue "+pf.value+" "+pf.name);
    ...
    public void sendVnmrCmd() {
        if (vnmrCmd == null || vnmrIf == null)
            return;
    if(debug)
        System.out.println("VFileTable.sendVnmrCmd");
        sendValueCmd();
    }
