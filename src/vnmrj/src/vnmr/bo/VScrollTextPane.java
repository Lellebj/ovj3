...
public class VScrollTextPane extends JScrollPane implements VObjIF, VObjDef,
	  DropTargetListener, PropertyChangeListener
{
    ...
    public VScrollTextPane(SessionShare sshare, ButtonIF vif, String typ) {
	this.vnmrIf = vif;
	setOpaque(false);
	setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED);
        setHorizontalScrollBarPolicy(JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
	twin = new VTextPane(this, sshare, vif, typ);
