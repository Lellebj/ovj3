...
/**
 * Extend DefaultTableCellRenderer to display shuffler result cells.
 *
 * @author Mark Cao
 */
public class ShufCellRenderer extends DefaultTableCellRenderer {
     ...
     */
    public ShufCellRenderer(JComponent comp) {
	super();
	...
	if (value instanceof SearchResults) {
	    ...
	    if (content instanceof LockStatus) {
		if (((LockStatus)content).lock) {
		    icon.setLine1Icon(lockIcon);
		    icon.setLine2Icon(null);
		}
	...
	Component result =
	    super.getTableCellRendererComponent(table, value, isSelected,
						hasFocus, row, column);
// If theme is a DARK color, these colors don't work
