...
/********************************************************** <pre>
 * Summary: File Open Popup
 *
 * Create a Modal popup frame for VJFileBrowser for Open  function
 </pre> **********************************************************/

public class VJOpenPopup extends JDialog implements PropertyChangeListener{
    static private VJFileBrowser fileBrowser=null;


    public VJOpenPopup() {
        // Set this JDialog as owned by the VNMRFrame and set modal to true
        super(VNMRFrame.getVNMRFrame(), Util.getLabel("blOpen"), true);
        ...
        // unshow this dialog
        fileBrowser = new VJFileBrowser(sshare, Util.getLabel("blOpen"), this);
        add(fileBrowser);
    ...
    public static void writePersistence() {
        if(fileBrowser != null)
            ...
            fileBrowser.writePersistence((Util.getLabel("blOpen")));
    }
