...
/* cosyps - homonuclear correlation   (phase-sensitive version)
 ...
 Parameters:
  ...
  presat = length of decoupler presaturation period; if PRESAT > 0, D1 is
           redueced to (D1 - PRESAT) and the presaturation period is added
           in after that period; does not depend on DM but does depend on DMM.
