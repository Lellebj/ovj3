...
code has the
  ...
  * <dt> # <dd> use "alternate" format. Add 0 or 0x for octal  or
...
(scientific  format).  The E format results in an uppercase E for
the exponent (1.14130E+003), the e format in a lowercase e.
  * <dt>g, G <dd> floating point number in general format  (fixed
format  for small numbers, exponential format for large numbers).
...
lowercase e.
  ...
  */
   ...
   public static void print(java.io.PrintStream  s,  String  fmt,
double x)
...
String x)
  ...
  */
   ...
   public static void print(java.io.PrintWriter  s,  String  fmt,
double x)
   {  s.print(new Format(fmt).form(x));
   }
...
String x)
  ...
  /**
  * Converts a string of digits (decimal, octal  or  hex)  to  an
integer
  * @param s a string
...
base 10 integer
  */
  ...
  /**
  * Converts a string of digits (decimal, octal or hex) to a long
integer
  * @param s a string
  * @return the numeric value of the prefix of s  representing  a
base 10 integer
...
Character.isWhitespace(s.charAt(i))) i++;
   ...
   */
   ...
   {  double x = 1.23456789012;
      ...
      double u = 1.234e-5;
      int d = 0xCAFE;
      Format.print(System.out, "x = |%f|0", x);
      Format.print(System.out, "u = |%20f|0", u);
      Format.print(System.out, "x = |% .5f|0", x);
      Format.print(System.out, "w = |%20.5f|0", w);
      Format.print(System.out, "x = |%020.5f|0", x);
      Format.print(System.out, "x = |%+20.5f|0", x);
      Format.print(System.out, "x = |%+020.5f|0", x);
      Format.print(System.out, "x = |% 020.5f|0", x);
      Format.print(System.out, "y = |%#+20.5f|0", y);
      Format.print(System.out, "y = |%-+20.5f|0", y);
      Format.print(System.out, "z = |%20.5f|0", z);

      Format.print(System.out, "x = |%e|0", x);
      Format.print(System.out, "u = |%20e|0", u);
      Format.print(System.out, "x = |% .5e|0", x);
      Format.print(System.out, "w = |%20.5e|0", w);
      Format.print(System.out, "x = |%020.5e|0", x);
      Format.print(System.out, "x = |%+20.5e|0", x);
      Format.print(System.out, "x = |%+020.5e|0", x);
      Format.print(System.out, "x = |% 020.5e|0", x);
      Format.print(System.out, "y = |%#+20.5e|0", y);
      Format.print(System.out, "y = |%-+20.5e|0", y);

      Format.print(System.out, "x = |%g|0", x);
      Format.print(System.out, "z = |%g|0", z);
      Format.print(System.out, "w = |%g|0", w);
      Format.print(System.out, "u = |%g|0", u);
      Format.print(System.out, "y = |%.2g|0", y);
      Format.print(System.out, "y = |%#.2g|0", y);

      Format.print(System.out, "d = |%d|0", d);
      Format.print(System.out, "d = |%20d|0", d);
      Format.print(System.out, "d = |%020d|0", d);
      Format.print(System.out, "d = |%+20d|0", d);
      Format.print(System.out, "d = |% 020d|0", d);
      Format.print(System.out, "d = |%-20d|0", d);
      Format.print(System.out, "d = |%20.8d|0", d);
      Format.print(System.out, "d = |%x|0", d);
      Format.print(System.out, "d = |%20X|0", d);
      Format.print(System.out, "d = |%#20x|0", d);
      Format.print(System.out, "d = |%020X|0", d);
      Format.print(System.out, "d = |%20.8x|0", d);
      Format.print(System.out, "d = |%o|0", d);
      Format.print(System.out, "d = |%020o|0", d);
      Format.print(System.out, "d = |%#20o|0", d);
      Format.print(System.out, "d = |%#020o|0", d);
      Format.print(System.out, "d = |%20.12o|0", d);

      Format.print(System.out, "s = |%-20s|0", "Hello");
      Format.print(System.out, "s = |%-20c|0", '!');

      // regression test to confirm fix of reported bugs

      Format.print(System.out, "|%i|0", Long.MIN_VALUE);

      Format.print(System.out, "|%6.2e|0", 0.0);
      Format.print(System.out, "|%6.2g|0", 0.0);

      Format.print(System.out, "|%6.2f|0", 9.99);
      Format.print(System.out, "|%6.2f|0", 9.999);

      Format.print(System.out, "|%6.0f|0", 9.999);
   }
...
r.charAt(0) != '0') p = "0";
   ...
   {  boolean removeTrailing
      ...
      for  (int  i  =  1;   i   <=   precision   &&   factor   <=
0x7FFFFFFFFFFFFFFFL; i++)
      {  factor *= 10;
