...
#define NBMASK        0x0000f

#define ND_NP       0x00010
#define ND_NF       0x00020
#define ND_NI       0x00040
#define ND_NI2      0x00080
#define ND_NI3      0x00100

#define ND_PHMODE   0x01000
#define ND_AVMODE   0x02000
#define ND_PWRMODE  0x04000
#define ND_PAMODE   0x08000
...
#define S_BC		0x40	/* 1 = baseline corrected	  */
...
/* NB. This is not used in the status word */
/*     It is used in the nbheaders word for 4D */
/*     The short status word does not have enough bits to describe 4D. */
/*     The nbheaders integer is used */
#define S_NI3		0x10000	/* 1 = ni3 dimension is active	*/
...
extern int D_downsize(int newnp);
